...
const DroneModel = dynamic(() => import("@/components/shared/DroneModel"), { ssr: false });
                  ...
                  {showModel ? (
                    ...
                    <div className="relative h-full w-full overflow-hidden rounded-2xl">
                      ...
                      <button
                        ...
                        className="btn-interaction absolute bottom-5 left-5 hidden rounded-lg border border-[rgba(var(--accent-rgb),0.28)] bg-[rgba(var(--accent-rgb),0.12)] px-5 py-3 text-xs font-black uppercase tracking-[0.16em] text-[var(--accent)] backdrop-blur-md transition-colors duration-300 hover:bg-[var(--accent)] hover:text-[var(--button-contrast)] sm:inline-flex"
                      >
                        Load 3D View
                      </button>
                    </div>
